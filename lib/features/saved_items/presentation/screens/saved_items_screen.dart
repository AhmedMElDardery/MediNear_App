...
class _SavedItemsScreenState extends ConsumerState<SavedItemsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.watch(savedItemsProvider).fetchSavedItems();
    });
  }
      ...
      itemBuilder: (context, index) {
        ...
        return _buildDismissibleItem(
          ...
          onDismissed: () {
            ...
            _showUndoSnackBar(
                context,
                '${pharmacy.name} removed from saved items.',
                theme,
                () => provider.undoRemovePharmacy(pharmacy));
          },
      ...
      itemBuilder: (context, index) {
        ...
        return _buildDismissibleItem(
          ...
          onDismissed: () {
            ...
            _showUndoSnackBar(
                context,
                '${medication.name} removed from saved items.',
                theme,
                () => provider.undoRemoveMedication(medication));
          },
  ...
  void _showUndoSnackBar(BuildContext context, String message, ThemeData theme,
      VoidCallback onUndo) {
