...
class AboutRemoteDataSource {
  Future<List<SupportModel>> getSupportOptions() async {
    ...
    return [
      SupportModel(title: "Help Center & FAQ", icon: Icons.headset_mic_outlined),
      SupportModel(title: "Chat with Support", icon: Icons.chat_bubble_outline),
      SupportModel(title: "Email Policy", icon: Icons.email_outlined, trailingIcon: Icons.copy_outlined),
      SupportModel(title: "Call Us", icon: Icons.phone, trailingIcon: Icons.copy_outlined),
    ];
  }
